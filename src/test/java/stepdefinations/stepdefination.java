...
public class stepdefination extends base{
	...
	public void user_go_to_my_cart() throws Throwable {

		bag=new BagLocators(driver);
		try {
			WaitForWebelement(bag.BagIcon());
			Assert.assertTrue(bag.BagIcon().isDisplayed(), "BagIcon is displayed");
			bag.BagIcon().click();
			Thread.sleep(4000);
		}catch(Exception e) {}
	...
	public void click_on_Continue_Shopping_CTA() throws Throwable{
		try {
			WaitForWebelement(bag.continueShoppingEmptybagCTA());
			bag.continueShoppingEmptybagCTA().click();
	...
	public void user_redrects_to_home_page() throws Throwable {
		try {
			WaitForWebelement(L.getlogin());
			L.getlogin().isDisplayed();
			Thread.sleep(4000);
		}catch(Exception e) {}
	}
	...
	public void Add_product_to_cart() throws Throwable {
		try {
			bag=new BagLocators(driver);
			//driver=BrowserConfig();
			String product_URL = prop.getProperty("productURL_p6");
			driver.navigate().to(product_URL);
			WaitForWebelement(bag.SizeSelected_M());
			bag.SizeSelected_M().click();
			bag.AddtoBag().click();
	...
	public void product_removed_from_bag() throws Throwable {
		try {
			WaitForWebelement(bag.RemovefromBag());
			bag.RemovefromBag().isDisplayed();
			bag.RemovefromBag().click();
			Thread.sleep(4000);
		}catch(Exception e) {}
	}

	@Then("^click on Save for later in bag$") 
	public void click_on_Save_for_later_in_bag() throws Throwable {
		try {
			WaitForWebelement(bag.Saveforlater());
			bag.Saveforlater().isDisplayed();
			bag.Saveforlater().click();
			Thread.sleep(4000);
		}catch(Exception e) {}
	}
	
	@Then("^click on Have a gift code in bag$") 
	public void click_on_Have_a_gift_code_in_bag() throws Throwable {
		try {
			WaitForWebelement(bag.Saveforlater());
			bag.Saveforlater().isDisplayed();
			bag.Saveforlater().click();
